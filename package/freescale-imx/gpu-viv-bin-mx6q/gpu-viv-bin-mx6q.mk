...
GPU_VIV_BIN_MX6Q_SOURCE  = gpu-viv-bin-mx6q-3.10.17-1.0.0-beta-hfp.bin
...
define GPU_VIV_BIN_MX6Q_INSTALL_STAGING_CMDS
	cp -r $(@D)-beta-hfp/usr/* $(STAGING_DIR)/usr
...
define GPU_VIV_BIN_MX6Q_INSTALL_EXAMPLES
	...
	cp -r $(@D)-beta-hfp/opt/* $(TARGET_DIR)/usr/share/examples/
endef
endif
...
define GPU_VIV_BIN_MX6Q_INSTALL_TARGET_CMDS
	...
	cp -a $(@D)-beta-hfp/usr/lib $(TARGET_DIR)/usr
