...
define IPCDEV_RUN_CONFIG
    cd $(@D) ; make -f ipc-linux.mak config  KERNEL_INSTALL_DIR=$(LINUX_DIR)  TOOLCHAIN_PREFIX=$(TARGET_CROSS) TOOLCHAIN_LONGNAME=arm-linux-gnueabihf  PLATFORM=OMAP54XX DESTDIR=/usr
endef
